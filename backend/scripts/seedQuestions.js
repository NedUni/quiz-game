...
const QUESTIONS = [
  {
    ...
    correctIndex: 2,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_Australia_%28converted%29.svg/640px-Flag_of_Australia_%28converted%29.svg.png',
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg/480px-Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg',
  },
  {
    text: 'What is the largest ocean on Earth?',
    options: ['Atlantic', 'Indian', 'Arctic', 'Pacific'],
    correctIndex: 3,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Pacific_Ocean_-_en.png/640px-Pacific_Ocean_-_en.png',
  },
  {
    text: 'Which animal is shown here?',
    options: ['Lion', 'Tiger', 'Cheetah', 'Leopard'],
    correctIndex: 1,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Tiger.50.jpg/480px-Tiger.50.jpg',
  },
  {
    text: 'What landmark is pictured?',
    options: ['Big Ben', 'Eiffel Tower', 'Statue of Liberty', 'Sydney Opera House'],
    correctIndex: 3,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Sydney_Opera_House_Sails.jpg/640px-Sydney_Opera_House_Sails.jpg',
  },
  {
  ...
  },
  {
    ...
    correctIndex: 0,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Flag_of_Japan.svg/640px-Flag_of_Japan.svg.png',
  },
